    ...
    <div ref={containerRef} className="relative space-y-1">
      ...
      <div className="relative">
        <input
          ...
          autoComplete="off"
          className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm shadow-sm transition-all focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
        />
        {isLoading && (
        ...
        <ul className="absolute z-50 mt-1 w-full rounded-lg border border-gray-200 bg-white shadow-lg">
          {suggestions.map((client) => (
            <li
              ...
              className="flex cursor-pointer items-center justify-between px-4 py-2.5 text-sm hover:bg-primary-50"
            >
