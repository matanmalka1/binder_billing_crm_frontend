      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
        <table className="w-full border-collapse text-sm">
          <thead className="bg-gray-50/80 text-xs font-semibold text-gray-500 backdrop-blur-sm">
            <tr>
              <th scope="col" className="px-4 py-3 text-right">קטגוריה</th>
              <th scope="col" className="px-4 py-3 text-right">% ניכוי</th>
              <th scope="col" className="px-4 py-3 text-right">הוצאה ברוטו</th>
              <th scope="col" className="px-4 py-3 text-right">מע"מ בחשבוניות</th>
              <th scope="col" className="px-4 py-3 text-right">מע"מ לניכוי</th>
            </tr>
          </thead>
            ...
            {rows.map((row) => {
              ...
              return (
                <tr key={row.categoryKey} className="group transition-colors hover:bg-blue-50/30">
                  ...
                  <td className="px-4 py-3 font-mono tabular-nums text-gray-600">
          ...
          <tfoot className="border-t-2 border-gray-200 bg-gray-50 text-gray-900">
            <tr className="font-bold">
              ...
              <td /> {/* Empty spacer for Rate column */}
              ...
              <td className={cn(
                "px-4 py-3 font-mono tabular-nums underline decoration-2 underline-offset-4",
                VAT_DEDUCTIBLE_ACCENT
              )}>
