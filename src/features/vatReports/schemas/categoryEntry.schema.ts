...
import { z } from 'zod'
import { CATEGORY_LABELS, EXPENSE_CATEGORIES, type ExpenseCategoryKey } from '../constants'
...
export const categoryEntryDefaultValues = (): CategoryEntryFormValues => ({
  income: emptyRow(),
  categories: Object.fromEntries(EXPENSE_CATEGORIES.map((k) => [k, emptyRow()])) as Record<
    ExpenseCategoryKey,
    CategoryRowValues
  >,
})
