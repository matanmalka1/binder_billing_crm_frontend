...
export const getTaxProfileFormValues = (
...
export const VAT_REPORTING_FREQUENCY_OPTIONS: SelectOption[] =
  VAT_REPORTING_FREQUENCIES.map((value) => ({
    value,
...
export const getTaxProfileItems = (
  ...
  },
  {
    ...
    value:
      profile?.advance_rate != null
        ? `${profile.advance_rate}%`
        : EMPTY_TAX_PROFILE_VALUE,
  },
];
