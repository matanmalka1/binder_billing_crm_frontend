...
type AnnualReportSidebarNavProps = ComponentProps<
  typeof AnnualReportSidebarNav
>;
type AnnualReportSidebarStatusProps = ComponentProps<
  typeof AnnualReportSidebarStatus
>;

type AnnualReportSidebarProps = AnnualReportSidebarNavProps &
